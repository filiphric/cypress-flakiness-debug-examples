...
const QuantityControl = ({ quantity, setQuantity }: QuantityControlProps) => {
  ...
  return (
    <div className="flex flex-row h-10 w-32 rounded-lg relative bg-transparent mt-1">
      ...
      <input type="number" className="focus:outline-none text-center w-full bg-gray-300 font-semibold text-md hover:text-black focus:text-black md:text-basecursor-default flex items-center text-gray-700 outline-none" name="custom-input-number" value={quantity} />
